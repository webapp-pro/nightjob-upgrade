    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-12 col-12"> 
                <!-- <a href="{{url('/')}}" class="logo"><img src="{{ asset('/') }}sitesetting_images/thumb/{{ $siteSetting->site_logo }}" alt="{{ $siteSetting->site_name }}" /></a> -->
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item {{ Request::url() == route('index') ? 'active' : '' }}"><a href="{{url('/')}}" class="nav-link">{{__('トップページ')}}</a> </li>
                            ...
                            <li class="nav-item"><a href="{{route('login')}}" class="nav-link">{{__('サインイン')}}</a> </li>
							<li class="nav-item"><a href="{{route('register')}}" class="nav-link register">{{__('会員登録')}}</a> </li>                            
                            <!-- @endif -->
